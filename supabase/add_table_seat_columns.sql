...
-- Add some sample data for testing (optional - remove this section if you don't want sample data)
-- UPDATE rsvps SET "table" = 1, seat = 1 WHERE id = 1;
-- UPDATE rsvps SET "table" = 1, seat = 2 WHERE id = 2;
-- UPDATE rsvps SET "table" = 2, seat = 1 WHERE id = 3; 